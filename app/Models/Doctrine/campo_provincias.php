            ...
            <script>
                $(document).ready(function(){
                    ...
                    function updateProvincias(regionId){
                        ...
                        $.ajax({
                        method: "get",
                        url: "https://ybedaafdk8.execute-api.us-west-2.amazonaws.com/simple/regiones/"+regionId+"/provincias",
                        success: function(data) {    
                    ...
                    function updateComunas(provinciaId){
                        ...
                        $.ajax({
                        method: "get",
                        url: "https://ybedaafdk8.execute-api.us-west-2.amazonaws.com/simple/provincias/"+provinciaId+"/comunas",
                        success: function(data) {
