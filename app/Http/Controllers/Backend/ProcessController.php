...
class ProcessController extends Controller
{
    ...
    public function destroy(Request $request, $proceso_id)
    {
        ...
        $request->session()->flash('success', 'Proceso desactivado con éxito.');
    ...
    public function ajax_editar($proceso_id)
    {
        ...
        $categorias = Categoria::where('cuenta_id',Auth::user()->cuenta_id)->get();
    ...
    public function editar_form(Request $request, $proceso_id)
    {
        ...
        $proceso->nombre_frontend = $request->input('nombre_frontend');
        $proceso->codigo_rnt = $request->input('codigo_rnt');
        ...
        $proceso->descarga_documentos = $request->has('descarga_documentos') ? 1 : 0;
    ...
    public function editar_tarea_form(Request $request, $tarea_id)
    {
        ...
        $tarea->vencimiento_notificar_dias = $request->input('vencimiento_notificar_dias', 1);
    ...
    public function import(Request $request)
    {
        ...
        if ($file_path) {
            ...
            if(strlen($proceso->nombre) > 128){
                $request->session()->flash('error', 'El nombre del proceso contiene más caracteres de los permitidos.');
