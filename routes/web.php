...
Route::middleware(['auth_user'])->group(function () {
    ...
    Route::get('/categoria/{categoria_id}/procesos', 'HomeController@procesosCategoria')->name('home.procesos');
...
//    Route::get('/terminos-y-condiciones', 'HomeController@terminosFront')->name('front.terminos');
    ...
    Route::get('/documentos/get/{inline}/{etapa_id}/{filename}/{usuario_backend?}', 'DocumentController@get')->name('document.get');
    ...
    Route::get('/schedule/vencidas/obtener', 'ScheduleController@vencidas_obtener')->name('schedule.vencidas.obtener');
    Route::get('/schedule/vencidas/avanzar/{etapa_id}', 'ScheduleController@vencidas_avanzar')->name('schedule.vencidas.avanzar');
});
...
Route::prefix('backend')->namespace('Backend')->name('backend.')->group(function () {
    ...
    Route::middleware('auth:usuario_backend')->group(function () {
        ...
        //Route::middleware('check_terms')->group(function () {
            ...
            Route::post('/uploader/sello_agua', 'UploaderController@sello_agua')->name('uploader.sello_agua');
            Route::get('/uploader/sello_agua_get/{filename}', 'UploaderController@sello_agua_get')->name('uploader.sello_agua_get');
            ...
            Route::get('documentos/getb/{inline}/{etapa_id}/{filename}/{usuario_backend?}', 'DocumentController@getb')->name('document.getb');
            ...
            Route::get('agendas', function() { //necesario para evitar el error de route not found
                return redirect('/backend/procesos');
           ...
           // Route::middleware('can:notificaciones')->group(function () {
                Route::get('notificaciones', 'ManagementController@notificaciones')->name('notificaciones');
                Route::get('notificaciones/ver_detalles/{id}', 'ManagementController@view')->name('notificaciones.view');
          //  });
...
Route::prefix('manager')->namespace('Manager')->name('manager.')->group(function () {
    ...
    Route::middleware('auth:usuario_manager')->group(function () {
        ...
        //MessageBackend https://git.gob.cl/simple/simple/issues/648
        Route::get('/message_backend', 'MessageBackendController@index')->name('message_backend.index');
        Route::get('/message_backend/editar/{message_id?}', 'MessageBackendController@edit')->name('message_backend.edit');
        Route::post('/message_backend/editar_form/{message_id?}', 'MessageBackendController@edit_form')->name('message_backend.edit_form');
        Route::get('/message_backend/eliminar/{message_id}', 'MessageBackendController@delete')->name('message_backend.delete');
        Route::get('/message_backend/cambiar_estado/{message_id}/{activar?}', 'MessageBackendController@cambiar_estado')->name('message_backend.cambiar_estado');
