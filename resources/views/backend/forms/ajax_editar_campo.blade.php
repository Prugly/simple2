    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="formEditarCampo" class="ajaxForm" method="POST"
                ...
                <label>Nombre (Máximo de caracteres 30)</label>
                <?php endif; ?>

                <div class="input-group">
                    <?php if ($campo->requiere_nombre): ?>
                    <input type="text" class="form-control col-4" id="nombre" maxlength="30"  placeholder="Máximo de caracteres 30" name="nombre"
                           value="<?= $campo->nombre ?>"/>
