                            ...
                            <td>
                                <form method="GET" class="form-inline"
                                    ...
                                    <div class="input-group col-4">
                                        <input type='text' autocomplete="off" name='created_at_desde' id='created_at_desde' placeholder='Desde'
                                               class='datetimepicker form-control col-5'/>
                                        <input type='text' autocomplete="off" name='created_at_hasta' id='created_at_hasta' placeholder='Hasta'
                                               class='datetimepicker form-control col-5'/>
                                    </div>
...
@section('script')
    <script type="text/javascript">
        $(function () {
            ...
            $("#created_at_desde").val('');
            $("#created_at_hasta").val('');
        });
    </script>
@endsection